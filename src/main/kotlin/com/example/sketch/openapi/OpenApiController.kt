...
//            }
    ...
    @GetMapping(GET_OVERSEAS_STOCK_ORDER_UNFILLED)
    suspend fun getOverseasUnfilledOrders(
        @ModelAttribute request: GetOverseasUnfilledOrdersRequest,
    ): OpenApiResponse {
        return service.getOverseasUnfilledOrders(request)
    }
...
internal fun OpenApiResponse.toPostStockOrderResponse(): ApiResponse.StockOrder {
    ...
    return stockOrder {
        ...
        output = output {
            ...
            oRDTMD = outputNode.text("ORD_TMD", "ord_tmd", "ordTmd", "THCO_ORD_TMD", "thco_ord_tmd", "thcoOrdTmd")
        }
    }
}
