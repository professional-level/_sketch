...
internal class OrderExecutionOutboxPublisher(
    ...
    private suspend fun markPublishedResult(event: OrderExecutionOutboxMessage): String {
        return runCatching {
    ...
    private suspend fun markFailedResult(event: OrderExecutionOutboxMessage, exception: Throwable): String {
        return runCatching {
