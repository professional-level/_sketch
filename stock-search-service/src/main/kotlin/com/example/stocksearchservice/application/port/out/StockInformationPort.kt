...
interface StockInformationPort {
    ...
    fun getHighestPriceAtCurrentDay(id: String): List<SimpleStockDTO> // TODO: 반환용 DTO에 대한 고민이 필요

    // 지금 시점의 프로그램 순매수금액
    fun getCurrentProgramPureBuyingVolume(id: String): Long // TODO: 이걸 보니 확실히 DTO가 많아야 하는것이 생각이 듬
