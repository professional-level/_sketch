...
@UseCase
interface RecordLaorOrderAnomalyUseCase {
    suspend fun execute(command: RecordLaorOrderAnomalyCommand): RecordLaorOrderAnomalyResult
}

data class RecordLaorOrderAnomalyCommand(
    val eventId: String,
...
data class RecordLaorOrderAnomalyResult(
    val strategyExecutionId: String,
    val status: RecordLaorOrderAnomalyStatus,
)

enum class RecordLaorOrderAnomalyStatus {
    RECORDED,
    SKIPPED_DUPLICATE,
}
